...
def main():
    ...
    if sys.argv[1] == '--app' or sys.argv[1] == '-a':
        ...
        # Check if user wants to analyze column library
        analyze_library = '--library' in sys.argv or '-l' in sys.argv
        ...
        print(f"\nTip: Run 'python -m strategy_cruncher.run --app' for the interactive web interface.")
        print(f"{'='*70}\n")
